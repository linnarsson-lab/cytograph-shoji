...
class PCA:
	...
	def fit(self, ds: loompy.LoomConnection, normalizer: Log2Normalizer, cells: np.ndarray = None) -> None:
		if cells is None:
	...
	def transform(self, ds: loompy.LoomConnection, normalizer: Log2Normalizer, cells: np.ndarray = None) -> np.ndarray:
		if cells is None:
	...
	def fit_transform(self, ds: loompy.LoomConnection, normalizer: Log2Normalizer, cells: np.ndarray = None) -> np.ndarray:
