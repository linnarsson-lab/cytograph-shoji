...
from cytograph.enrichment import FeatureSelectionByVariance, FeatureSelectionByMultilevelEnrichment
...
class Cytograph:
	...
	def fit(self, ds: loompy.LoomConnection) -> None:
		...
		if self.config.params.features == "enrichment":
			...
			genes = FeatureSelectionByMultilevelEnrichment(int(self.config.params.n_genes // n_labels), Species.mask(ds, self.config.params.mask), findq=False).select(ds)
